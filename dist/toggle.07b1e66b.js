...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app/js/toggle.js":[function(require,module,exports) {
var radioList = document.querySelector('[role="radiogroup"]');
var radios = radioList.querySelectorAll('[role="radio"]');
...
var setColorMode = function setColorMode() {
  var currentSetting = localStorage.getItem('--color-mode');
...
radios.forEach(function (radio) {
  return radio.addEventListener('click', function (e) {
    radios.forEach(function (radio) {
      return radio.setAttribute('tabindex', -1);
    });
...
radioList.addEventListener('keydown', function (e) {
  var keydownLeft = 37;
  var keydownRight = 39;
  var keydownUp = 38;
  var keydownDown = 40; // change the tabindex of the current tab to -1
  ...
  var theme = radios[tabFocus].getAttribute('id');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40649" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/js/toggle.js"], null)
//# sourceMappingURL=/toggle.07b1e66b.js.map